...
const PUBLIC = ["/login", "/join", "/demo", "/setup", "/forgot", "/reset", "/removed", "/api/cron", "/api/health", "/api/webhooks", "/api/session", "/manifest.webmanifest", "/icon", "/apple-icon", "/pwa-icon", "/robots.txt", "/g", "/m", "/files"];
