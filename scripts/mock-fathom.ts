...
const meetings = [
  { recording_id: 9001, title: "Jess and Evolve Omega", url: "https://fathom.video/share/jess-9001", share_url: "https://fathom.video/share/jess-9001", created_at: "2026-09-01T16:00:00Z", recording_start_time: "2026-09-01T16:00:00Z", recording_end_time: "2026-09-01T16:45:00Z", calendar_invitees: [{ name: "Jess Morgan", email: "jess@example.com", is_external: true }, { name: "Maya Torres", email: "client@demo.helixos.app", is_external: false }] },
...
const transcripts: Record<string, { speaker: { display_name: string; matched_calendar_invitee_email: string | null }; text: string; timestamp: string }[]> = {
  "9001": [
    ...
    { speaker: { display_name: "Jess Morgan", matched_calendar_invitee_email: "jess@example.com" }, text: "Honestly it's been different. I've had three new clients this month and I didn't chase a single one.", timestamp: "00:12:19" },
    { speaker: { display_name: "Jess Morgan", matched_calendar_invitee_email: "jess@example.com" }, text: "Before this I was posting every day and getting nothing back.", timestamp: "00:12:31" },
    ...
    { speaker: { display_name: "Jess Morgan", matched_calendar_invitee_email: "jess@example.com" }, text: "The comment ladders. People read the whole thing and message me.", timestamp: "00:12:47" },
  ],
